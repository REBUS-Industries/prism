...
import { signallingProxyRegistry, type ControlSub, type ViewerTier, type ControlChange } from './signallingProxyRegistry.js';
import { sendSetViewerControlToAgent } from './agentProtocol.js';
