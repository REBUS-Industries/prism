...
VM 211 to be reachable from the public internet.
...
|---|---|---|---|---|
| `coturn-stun-udp` | UDP | `3478` | `10.0.200.211` | `3478` |
| `coturn-stun-tcp` | TCP | `3478` | `10.0.200.211` | `3478` |
| `coturn-tls` | TCP | `5349` | `10.0.200.211` | `5349` |
| `coturn-relay-udp` | UDP | `52000-56999` | `10.0.200.211` | `52000-56999` |
...
DNS to `10.0.200.211:3478` directly, which is unrelated — make sure
